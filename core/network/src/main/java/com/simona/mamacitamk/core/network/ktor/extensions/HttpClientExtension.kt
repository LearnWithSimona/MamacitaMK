 ...
 * @return [ApiResponse]
 */
suspend inline fun <reified T> HttpClient.requestApiResponse(
 ...
 * @return [ApiResponse]
 */
suspend inline fun <reified T> HttpClient.postApiResponse(
    builder: HttpRequestBuilder,
): ApiResponse<T> {
 ...
 * @return [ApiResponse]
 */
suspend inline fun <reified T> HttpClient.putApiResponse(
    builder: HttpRequestBuilder,
): ApiResponse<T> {
 ...
 * @return [ApiResponse]
 */
suspend inline fun <reified T> HttpClient.deleteApiResponse(
    builder: HttpRequestBuilder,
): ApiResponse<T> {
 ...
 * @return [ApiResponse]
 */
suspend inline fun <reified T> HttpClient.optionsApiResponse(
    builder: HttpRequestBuilder,
): ApiResponse<T> {
 ...
 * @return [ApiResponse]
 */
suspend inline fun <reified T> HttpClient.patchApiResponse(
    builder: HttpRequestBuilder,
): ApiResponse<T> {
 ...
 * @return [ApiResponse]
 */
suspend inline fun <reified T> HttpClient.headApiResponse(
    builder: HttpRequestBuilder,
): ApiResponse<T> {
