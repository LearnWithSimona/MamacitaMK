...
import com.simona.mamacitamk.core.network.ktor.mappers.ApiErrorModelMapper
import com.simona.mamacitamk.core.network.ktor.mappers.ApiResponseMapper
import com.simona.mamacitamk.core.network.ktor.mappers.ApiSuccessModelMapper
 ...
 */
inline fun <reified T, reified V> ApiResponse<T>.flatMap(
 ...
 * @return A [V] type of the [ApiResponse].
 */
suspend inline fun <reified T, reified V> ApiResponse<T>.suspendFlatMap(
...
@JvmSynthetic
@Suppress("UNCHECKED_CAST")
suspend inline fun <reified T, reified V> ApiResponse<T>.suspendMapSuccess(
 ...
 */
fun <T> ApiResponse<T>.mapFailure(transformer: Any?.() -> Any?): ApiResponse<T> {
    contract { callsInPlace(transformer, InvocationKind.AT_MOST_ONCE) }
    if (this is ApiResponse.Failure.Error) {
        return ApiResponse.Failure.Error(payload = transformer.invoke(payload))
    } else if (this is ApiResponse.Failure.Exception) {
        return ApiResponse.exception(
            ex = (transformer.invoke(throwable) as? Throwable) ?: throwable,
        )
    }
    return this
}
 ...
 */
@JvmSynthetic
suspend fun <T> ApiResponse<T>.suspendMapFailure(
 ...
 */
fun <T> ApiResponse.Failure.Error.map(mapper: ApiErrorModelMapper<T>): T = mapper.map(this)
 ...
 * @return A mapped custom [T] error response model.
 */
fun <T> ApiResponse.Failure.Error.map(mapper: (ApiResponse.Failure.Error) -> T): T {
    contract { callsInPlace(mapper, InvocationKind.AT_MOST_ONCE) }
    return mapper(this)
}
 ...
 */
@JvmSynthetic
suspend inline fun <T> ApiResponse.Failure.Error.suspendMap(
    mapper: ApiErrorModelMapper<T>,
 ...
 * @return The encapsulated data.
 */
fun <T> ApiResponse<T>.tagOrNull(): Any? =
    if (this is ApiResponse.Success) {
        tag
    } else {
        null
 ...
 */
fun ApiResponse.Failure.Error.message(): String = payload?.toString() ?: toString()
 ...
 */
@JvmSynthetic
suspend inline fun <T, R> ApiResponse<T>.suspendFold(
 ...
 */
@JvmSynthetic
inline fun <T> ApiResponse<T>.recover(crossinline fallback: () -> T): ApiResponse<T> {
 ...
 */
@JvmSynthetic
suspend inline fun <T> ApiResponse<T>.suspendRecover(
 ...
 */
@JvmSynthetic
suspend inline fun <T> ApiResponse<T>.suspendValidate(
...
inline fun <T, R> ApiResponse<T>.requireNotNull(
    ...
    if (this is ApiResponse.Success) {
        ...
        return selected?.let { ApiResponse.Success(data = it, tag = tag) }
 ...
 */
@JvmSynthetic
inline fun <T> ApiResponse<List<T>>.filter(
    crossinline predicate: (T) -> Boolean,
): ApiResponse<List<T>> {
 ...
 */
@JvmSynthetic
suspend inline fun <T> ApiResponse<List<T>>.suspendFilter(
    crossinline predicate: suspend (T) -> Boolean,
): ApiResponse<List<T>> {
    if (this is ApiResponse.Success) {
 ...
 */
@JvmSynthetic
inline fun <T> ApiResponse<List<T>>.filterNot(
    crossinline predicate: (T) -> Boolean,
): ApiResponse<List<T>> {
    contract { callsInPlace(predicate, InvocationKind.UNKNOWN) }
    if (this is ApiResponse.Success) {
 ...
 */
@JvmSynthetic
suspend inline fun <T> ApiResponse<List<T>>.suspendFilterNot(
    crossinline predicate: suspend (T) -> Boolean,
): ApiResponse<List<T>> {
    if (this is ApiResponse.Success) {
...
@Suppress("UNCHECKED_CAST")
@JvmSynthetic
inline fun <T, U, R> ApiResponse<T>.zip(
    other: ApiResponse<U>,
    ...
    return when {
        ...
        this is ApiResponse.Failure -> {
            this as ApiResponse<R>
        }

        else -> {
            other as ApiResponse<R>
        }
    }
}
...
@Suppress("UNCHECKED_CAST")
@JvmSynthetic
suspend inline fun <T, U, R> ApiResponse<T>.suspendZip(
    other: ApiResponse<U>,
...
@Suppress("UNCHECKED_CAST")
@JvmSynthetic
inline fun <T, U, V, R> ApiResponse<T>.zip3(
    ...
    return when {
        ...
        second is ApiResponse.Failure -> {
            second as ApiResponse<R>
        }

        else -> {
            third as ApiResponse<R>
        }
    }
}
...
@Suppress("UNCHECKED_CAST")
@JvmSynthetic
suspend inline fun <T, U, V, R> ApiResponse<T>.suspendZip3(
    second: ApiResponse<U>,
    third: ApiResponse<V>,
...
@Suppress("UNCHECKED_CAST")
@JvmSynthetic
fun <T, U> ApiResponse<T>.zip(other: ApiResponse<U>): ApiResponse<Pair<T, U>> =
    when {
        this is ApiResponse.Success && other is ApiResponse.Success -> {
        ...
        this is ApiResponse.Failure -> {
            this as ApiResponse<Pair<T, U>>
        }

        else -> {
            other as ApiResponse<Pair<T, U>>
        }
    }
 ...
 */
@JvmSynthetic
inline fun <T> ApiResponse<T>.peek(
 ...
 */
@JvmSynthetic
suspend inline fun <T> ApiResponse<T>.suspendPeek(
 ...
 */
@JvmSynthetic
inline fun <T> ApiResponse<T>.peekSuccess(crossinline action: (T) -> Unit): ApiResponse<T> {
 ...
 */
@JvmSynthetic
suspend inline fun <T> ApiResponse<T>.suspendPeekSuccess(
 ...
 */
@JvmSynthetic
inline fun <T> ApiResponse<T>.peekFailure(
 ...
 */
@JvmSynthetic
suspend inline fun <T> ApiResponse<T>.suspendPeekFailure(
 ...
 */
@JvmSynthetic
inline fun <T> ApiResponse<T>.peekError(
 ...
 */
@JvmSynthetic
suspend inline fun <T> ApiResponse<T>.suspendPeekError(
 ...
 */
@JvmSynthetic
inline fun <T> ApiResponse<T>.peekException(
 ...
 */
@JvmSynthetic
suspend inline fun <T> ApiResponse<T>.suspendPeekException(
